...
export type RelationNodeType = 'relationBlock' | 'relationInlineBlock' | 'relationMark';
...
export type RelationReference = {
  ...
  stageEdits: (item: Record<string, any>, insertNode: (attrs: RelationNodeAttrs) => void) => void;
  ...
  mergeItemWithEdits: (itemFields: any, mergeFields: any, warning: any) => void;
  cloneItemByDuplicationFields: (itemFields: any, duplicationFieldsSchema: any) => Record<string, any>;
};
