...
const relationInlineBlocks: VueRelationNodeSerializers = [{ collection: 'color', component: Color }]
const relationMarks: VueRelationNodeSerializers = [{ collection: 'related_post', component: RelatedPost }]
